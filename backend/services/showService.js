...
class ShowService {
  ...
  updateData.artist_id ? updateData.artist_id =  await checkIfArtistExists(req.body.artist_id) : null;
  updateData.venue_id ? updateData.venue_id = await checkIfVenueExists(req.body.venue_id) : null;
  updateData.tour ? updateData.tour = await checkIfTourExists(req.body.tour_id) : null;
